...
# Приводим строку к числу, полученное число присваивается переменной year
year = int(input_text) 
...
# Функция, вычисляющая день недели, на который выпадет первое число следующего месяца
